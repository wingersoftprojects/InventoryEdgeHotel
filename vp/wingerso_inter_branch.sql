...
--
-- Host: localhost
-- Generation Time: Jul 17, 2016 at 08:49 PM
...
--
-- Database: `wingerso_inter_branch`
--
...
DROP TABLE IF EXISTS `points_card`;
...
(1, '4406893724', 'SSERWANGA ANDREW', 'dubaigroup@ymail.com', '0774060222', 'mbarara', '1002345413', 'ANDREW', '', 'DAYTODAY', '', '0704500416', '', 1, 63.1, '2015-04-26 14:24:26', 'Andrew Sserwanga ', '2015-04-26 14:24:26', 'Andrew Sserwanga ');
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_add_points_card_balance_by_card_id`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_add_points_card_balance_by_card_no`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_add_stock_by_store_item_batch`(
		IN in_store_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_copy_pay`(
	IN in_pay_id bigint,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_copy_transaction`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_copy_transaction_item`(
	IN in_transaction_id bigint,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_item_map`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_login_session_by_session`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_login_session_by_user`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_login_session_unlogged_out`()
BEGIN 
	SET @cur_sys_datetime=null;
	CALL sp_get_current_system_datetime(@cur_sys_datetime);
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_stage_points_transaction_by_id`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_stage_points_transaction_by_transaction_id`(
	IN in_transaction_id bigint 
)
BEGIN 
		DELETE FROM stage_points_transaction 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_delete_zero_qty_stock`()
BEGIN 
		DELETE FROM stock WHERE currentqty=0;
END$$

DROP PROCEDURE IF EXISTS `sp_get_current_system_datetime`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_current_system_datetime`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_current_system_datetime2`()
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_new_card_number`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_new_id`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_branch`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_discount_package`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_discount_package_item`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_group_detail`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_group_right`(
	IN in_store_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_group_user`(
	IN in_group_detail_id int,
	IN in_user_detail_id int 
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_item_location`(
	IN in_item_id bigint,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_item_map`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_location`(
	IN in_store_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_login_session`(
	IN in_user_detail_id int,
	IN in_store_id int,
	IN in_session_id varchar(100),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_pay`(
	IN in_transaction_id bigint,
	IN in_pay_date date,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_pay_method`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_points_card`(
	IN in_card_number varchar(10),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_points_transaction`(
	IN in_points_card_id bigint,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_stage_points_transaction`(
	IN in_points_card_id bigint,
	IN in_transaction_date date,
	IN in_points_awarded float,
	IN in_points_spent float,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_stock`(
		IN in_store_id int,
		IN in_item_id bigint,
		IN in_batchno varchar(100),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_store`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_sub_category`(
	IN in_category_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_transaction`(
	IN in_transaction_date date,
	IN in_store_id int,
	IN in_store2_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_transaction_approve`(
	IN in_transaction_id bigint,
	IN in_function_name varchar(50),
	IN in_user_detail_id int
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_transaction_item`(
	IN in_transaction_id bigint,
	IN in_item_id bigint,
	IN in_batchno varchar(100),
	IN in_item_qty float,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_transaction_reason`(
	IN in_transaction_type_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_transaction_type`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_transactor`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_transactor_ledger`(
	IN in_store_id int,
	IN in_store_name varchar(20),
	IN in_transaction_id bigint,
	IN in_pay_id bigint,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_unit`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_user_category`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_user_detail`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_user_item_earn`(
	IN in_transaction_type_id int,
	IN in_transaction_reason_id int,
	IN in_user_category_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insert_user_right`(
	IN in_store_id int,
	IN in_user_detail_id int,
	IN in_function_name varchar(50),
	IN in_allow_view varchar(3),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_bill`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_bill_items_summary`(
	IN in_transaction_id bigint 
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_bill_summary`(
	IN in_transaction_date_from date,
	IN in_transaction_date_to date,
	IN in_store_id int,
	IN in_bill_transactor_id bigint 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_item`(
	IN in_category_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_item_location`(
	IN in_store_id int,
	IN in_location_id bigint,
	IN in_item_id bigint
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_item_summary`(
	IN in_category_id int,
	IN in_sub_category_id int,
	IN in_is_suspended varchar(3)
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_pay`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_pay_summary`(
	IN in_pay_date_from date,
	IN in_pay_date_to date,
	IN in_store_id int,
	IN in_bill_transactor_id bigint,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_stock_all`(
	IN in_category_id int,
	IN in_sub_category_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_stock_all_summary`(
	IN in_category_id int,
	IN in_sub_category_id int,
	IN in_reorder_filter varchar(3)
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_stock_in`(
	IN in_store_id int,
	IN in_category_id int,
	IN in_sub_category_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_stock_in_summary`(
	IN in_store_id int,
	IN in_category_id int,
	IN in_sub_category_id int,
	IN in_expiry_date_from date,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_stock_total`(
	IN in_store_id int,
	IN in_category_id int,
	IN in_sub_category_id int
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_stock_total_summary`(
	IN in_store_id int,
	IN in_category_id int,
	IN in_sub_category_id int
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_transaction`(
	IN in_transaction_date_from date,
	IN in_transaction_date_to date,
	IN in_store_id int,
	IN in_store2_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_transaction_item`(
	IN in_transaction_date_from date,
	IN in_transaction_date_to date,
	IN in_store_id int,
	IN in_store2_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_transaction_item_user_earn`(
	IN in_transaction_date_from date,
	IN in_transaction_date_to date,
	IN in_store_id int,
	IN in_transaction_type_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_transaction_summary`(
	IN in_transaction_date_from date,
	IN in_transaction_date_to date,
	IN in_store_id int,
	IN in_store2_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_transaction_user_earn_summary`(
	IN in_transaction_date_from date,
	IN in_transaction_date_to date,
	IN in_store_id int,
	IN in_transaction_type_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_transactor`(
	IN in_transactor_type varchar(20)
)
BEGIN 
	SET @TransactorType='';
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_transactor_ledger`(
	IN in_store_id int,
	IN in_transaction_date_from date,
	IN in_transaction_date_to date,
	IN in_add_date_from datetime,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_transactor_ledger_summary_all`()
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_transactor_ledger_summary_all_individual`()
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_report_transactor_ledger_summary_single_individual`(
	IN in_bill_transactor_id bigint
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_branch_by_code`(
	IN in_branch_code varchar(20)
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_branch_by_id`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_branch_by_name`(
	IN in_branch_name varchar(100)
)
BEGIN 
		SELECT * FROM branch b 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_branch_by_none`()
BEGIN 
		SELECT * FROM branch b 
		ORDER BY branch_name ASC;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_category_by_id`(
	IN in_category_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_category_by_name`(
	IN in_category_name varchar(50)
)
BEGIN 
	SELECT * FROM category 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_category_by_none`()
BEGIN 
	SELECT * FROM category ORDER BY category_name ASC; 
END$$

DROP PROCEDURE IF EXISTS `sp_search_company_setting_by_id`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_company_setting_by_id`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_discount_package_by_id`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_discount_package_by_name`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_discount_package_by_none`()
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_discount_package_item_by_id`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_discount_package_item_by_item_id`(
	IN in_item_id bigint 
)
BEGIN 
		SELECT * FROM discount_package_item d 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_discount_package_item_by_package_id`(
	IN in_discount_package_id int 
)
BEGIN 
		SELECT * FROM discount_package_item d 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_discount_package_item_by_package_store`(
	IN in_discount_package_id int,
	In in_store_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_discount_package_item_by_package_store_item`(
	IN in_discount_package_id int,
	In in_store_id int,
	IN in_item_id bigint
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_discount_package_item_by_store_id`(
	IN in_store_id int 
)
BEGIN 
		SELECT * FROM discount_package_item d 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_discount_package_item_by_store_item`(
	In in_store_id int,
	IN in_item_id bigint
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_discount_package_item_by_store_item_qty_active`(
	IN in_store_id int,
	IN in_item_id bigint,
	IN in_item_qty float
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_discount_package_item_by_store_item_qty_all`(
	IN in_store_id int,
	IN in_item_id bigint,
	IN in_item_qty float
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_group_detail_by_id`(
	IN in_group_detail_id int 
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_group_detail_by_name`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_group_detail_by_none`()
BEGIN 
		SELECT * FROM group_detail g 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_group_right_by_group_id`(
	IN in_group_detail_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_group_right_by_group_id_store_id`(
	IN in_group_detail_id int,
	IN in_store_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_group_right_by_group_id_store_id_function`(
	IN in_group_detail_id int,
	IN in_store_id int,
	IN in_function_name varchar(50) 
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_group_right_by_id`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_group_right_by_store_id`(
	IN in_store_id int
)
BEGIN 
	SELECT * FROM group_right 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_group_right_get_active_rights_by_store_user`(
	IN in_store_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_active_by_code`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_active_by_code_desc`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_active_by_code_desc2`(
	IN in_code_desc varchar(100) 
)
BEGIN  
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_active_by_code_desc_old`(
	IN in_code_desc varchar(100) 
)
BEGIN  
		SELECT * FROM item 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_active_by_code_desc_very_old`(
	IN in_code_desc varchar(100) 
)
BEGIN  
		SELECT * FROM view_item 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_by_code`(
	IN in_item_code varchar(255)
)
BEGIN 
		SELECT * FROM view_item 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_by_code_desc`(
	IN in_code_desc varchar(100) 
)
BEGIN  
		SELECT * FROM view_item 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_by_id`(
	IN in_item_id bigint 
)
BEGIN 
		SELECT * FROM view_item 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_by_id_and_code`(
	IN in_item_id bigint,
	IN in_item_code varchar(50)  
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_location`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_map_by_big_item_id`(
	IN in_big_item_id bigint
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_map_by_big_small_item_id`(
	IN in_big_item_id bigint,
	IN in_small_item_id bigint
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_map_by_id`(
	IN in_item_map_id bigint
)
BEGIN 
	SELECT * FROM item_map 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_map_by_map_group_id`(
	IN in_map_group_id bigint
)
BEGIN 
	SELECT * FROM item_map 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_map_by_small_item_id`(
	IN in_small_item_id bigint
)
BEGIN 
	SELECT * FROM item_map 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_item_map_get_count_map_group_id`(
	IN in_map_group_id bigint
)
BEGIN 
	SELECT * FROM item_map 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_location`(
	IN in_store_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_location_by_item_id`(
	IN in_item_id bigint
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_login_session`()
BEGIN 
	SELECT * FROM login_session ORDER BY user_detail_id,store_id;
END$$

DROP PROCEDURE IF EXISTS `sp_search_login_session_by_id`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_login_session_by_id`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_login_session_by_session`(
	IN in_session_id varchar(100)
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_login_session_by_user`(
	IN in_user_detail_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_by_bill_transactor_paycat`(
	IN in_bill_transactor_id bigint,
	IN in_pay_category varchar(10)
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_by_bill_transactor_transtype`(
	IN in_bill_transactor_id bigint,
	IN in_transaction_type_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_by_pay_id`(
	IN in_pay_id bigint
)
BEGIN 
	SELECT * FROM pay 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_by_transaction_id`(
	IN in_transaction_id bigint
)
BEGIN 
	SELECT * FROM pay 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_by_transaction_id_paycat`(
	IN in_transaction_id bigint,
	IN in_pay_category varchar(10)
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_by_transaction_id_type`(
	IN in_transaction_id bigint,
	IN in_transaction_type_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_by_transaction_number_paycat`(
	IN in_transaction_number varchar(50),
	IN in_pay_category varchar(10)
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_by_transactor_id`(
	IN in_transactor_id bigint
)
BEGIN 
	SELECT * FROM pay p 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_by_transactor_transtype`(
	IN in_transactor_id bigint,
	IN in_transaction_type_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_count_by_delete_pay_id`(
	IN in_delete_pay_id bigint
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_first_by_transaction_id`(
	IN in_transaction_id bigint
)
BEGIN 
	SELECT * FROM pay 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_first_by_transaction_number`(
	IN in_transaction_number varchar(50)
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_method_by_equal_name`(
	IN in_pay_method_name varchar(50)
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_method_by_id`(
	IN in_pay_method_id int
)
BEGIN 
	SELECT * FROM pay_method 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_method_by_name`(
	IN in_pay_method_name varchar(50)
)
BEGIN 
	SELECT * FROM pay_method 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_method_by_none`()
BEGIN 
	SELECT * FROM pay_method 
	ORDER BY pay_method_name ASC; 
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_pay_total_by_transaction_id`(
	IN in_transaction_id bigint
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_points_card_by_card_number`(
	IN in_card_number varchar(10) 
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_points_card_by_card_number_holder_names`(
	IN in_card_number varchar(10) 
)
BEGIN 
		SELECT * FROM points_card p 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_points_card_by_holder_names`(
	IN in_card_holder varchar(100) 
)
BEGIN 
		SELECT * FROM points_card p 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_points_card_by_id`(
	IN in_points_card_id bigint 
)
BEGIN 
		SELECT * FROM points_card p 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_points_transaction_by_card_id`(
	IN in_points_card_id bigint 
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_points_transaction_by_id`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_stage_points_transaction_by_id`(
	IN in_stage_points_transaction_id bigint 
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_stage_points_transaction_by_none`()
BEGIN 
		SELECT * FROM stage_points_transaction; 
END$$

DROP PROCEDURE IF EXISTS `sp_search_stage_points_transaction_by_transaction_id`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_stage_points_transaction_by_transaction_id`(
	IN in_transaction_id bigint 
)
BEGIN 
		SELECT * FROM stage_points_transaction 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_stock_by_id`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_stock_by_item_id`(
		IN in_item_id bigint 
)
BEGIN 
		SELECT * FROM stock s 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_stock_by_store_id`(
		IN in_store_id int
)
BEGIN 
		SELECT * FROM stock s 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_stock_by_store_item`(
		IN in_store_id int,
		IN in_item_id bigint 
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_stock_by_store_item_batch`(
		IN in_store_id int,
		IN in_item_id bigint,
		IN in_batchno varchar(100) 
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_store_by_id`(
	IN in_store_id int
)
BEGIN 
	SELECT * FROM store 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_store_by_name`(
	IN in_store_name varchar(20)
)
BEGIN 
	SELECT * FROM store 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_store_by_name_equal`(
	IN in_store_name varchar(20)
)
BEGIN 
	SELECT * FROM store 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_store_by_none`()
BEGIN 
	SELECT * FROM store ORDER BY store_name ASC; 
END$$

DROP PROCEDURE IF EXISTS `sp_search_store_by_user_detail`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_store_by_user_detail`(
	IN in_user_detail_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_sub_category_by_category_id`(
	IN in_category_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_sub_category_by_id`(
	IN in_sub_category_id int
)
BEGIN 
	SELECT * FROM view_sub_category 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_sub_category_by_name`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_sub_category_by_none`()
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_by_add_user_detail_id`(
	IN in_add_user_detail_id int,
	IN in_transaction_type_id int,
	IN in_store_id int
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_by_bill_transactor_transtype`(
	IN in_bill_transactor_id bigint,
	IN in_transaction_type_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_by_id`(
	IN in_transaction_id bigint 
)
BEGIN 
		SELECT * FROM transaction t 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_by_id_type`(
	IN in_transaction_id bigint,
	IN in_transaction_type_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_by_number`(
	IN in_transaction_number varchar(50) 
)
BEGIN 
		SELECT * FROM transaction t 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_by_number_type`(
	IN in_transaction_number varchar(50),
	IN in_transaction_type_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_by_store_id_type`(
	IN in_store_id int,
	IN in_transaction_id bigint,
	IN in_transaction_type_id int
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_by_store_number_type`(
	IN in_store_id int,
	IN in_transaction_number varchar(50),
	IN in_transaction_type_id int
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_by_transactor_id`(
	IN in_transactor_id bigint 
)
BEGIN 
		SELECT * FROM transaction t 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_by_transactor_transtype`(
	IN in_transactor_id bigint,
	IN in_transaction_type_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_deleted_by_id`(
	IN in_transaction_id bigint 
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_item_by_id`(
	IN in_transaction_item_id bigint 
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_item_by_transaction_id`(
	IN in_transaction_id bigint 
)
BEGIN 
		SELECT * FROM transaction_item ti 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_item_by_transaction_id2`(
	IN in_transaction_id bigint 
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_item_by_transaction_number`(
	IN in_transaction_number varchar(50) 
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_item_hist_by_ids`(
	IN in_transaction_id bigint,
	IN in_transaction_hist_id bigint
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_reason_by_id`(
	IN in_transaction_reason_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_reason_by_transtype_id`(
	IN in_transaction_type_id int
)
BEGIN 
	SELECT * FROM transaction_reason 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transaction_type_by_id`(
	IN in_transaction_type_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transactor_by_id`(
	IN in_transactor_id bigint
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transactor_by_name`(
	IN in_transactor_names varchar(100) 
)
BEGIN 
	SELECT * FROM transactor t 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transactor_by_name_type`(
	IN in_transactor_names varchar(100),
	IN in_transactor_type varchar(20)
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transactor_ledger_by_id`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transactor_ledger_by_min_transid_type_desc`(
	IN in_transaction_id bigint,
	IN in_transaction_type_name varchar(50),
	IN in_description varchar(50)
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_transactor_ledger_by_transid_transtype`(
	IN in_transaction_id bigint,
	IN in_transaction_type_name varchar(50)
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_unit_by_id`(
	IN in_unit_id int
)
BEGIN 
	SELECT * FROM unit 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_unit_by_name`(
	IN in_unit_name varchar(50)
)
BEGIN 
	SELECT * FROM unit 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_unit_by_none`()
BEGIN 
	SELECT * FROM unit 
	ORDER BY unit_name ASC; 
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_user_category_by_id`(
	IN in_user_category_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_user_category_by_name`(
	IN in_search_name varchar(50)
)
BEGIN 
	SELECT * FROM user_category 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_user_category_by_none`()
BEGIN 
	SELECT * FROM user_category ORDER BY user_category_name ASC; 
END$$

DROP PROCEDURE IF EXISTS `sp_search_user_detail_all_active`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_user_detail_all_active`()
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_user_detail_by_id`(
	IN in_user_detail_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_user_detail_by_names`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_user_detail_by_none`()
BEGIN 
	SELECT * FROM user_detail ORDER BY user_name ASC; 
END$$

DROP PROCEDURE IF EXISTS `sp_search_user_detail_by_username`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_user_detail_by_username`(
	IN in_user_name varchar(20) 
)
BEGIN 
	SELECT * FROM user_detail 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_user_item_earn_by_id`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_user_item_earn_by_none`()
BEGIN 
		SELECT * FROM user_item_earn 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_user_item_earn_by_ttype_treas_icat_isubcat_ucat`(
	IN in_transaction_type_id int,
	IN in_transaction_reason_id int,
	IN in_item_category_id int,
	IN in_item_sub_category_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_search_user_item_earn_by_user_cat`(
	IN in_user_category_id int 
)
BEGIN 
		SELECT * FROM user_item_earn 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_subtract_points_card_balance`(
	IN in_card_number varchar(10),
	IN in_points float 
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_subtract_stock_by_store_item_batch`(
		IN in_store_id int,
		IN in_item_id bigint,
		IN in_batchno varchar(100),
		IN in_qty float 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_branch`(
	IN in_branch_id bigint,
	IN in_branch_code varchar(20),
	IN in_branch_name varchar(100)  
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_company_setting`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_company_setting_logo`(
	IN in_logo blob 
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_discount_package`(
	IN in_discount_package_id int,
	IN in_package_name varchar(50),
	IN in_start_date datetime,
	IN in_end_date datetime
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_discount_package_item`(
	IN in_discount_package_item_id bigint,
	IN in_discount_package_id int,
	IN in_store_id int,
	IN in_item_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_group_detail`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_group_right`(
	IN in_group_right_id int,
	IN in_store_id int,
	IN in_group_detail_id int,
	IN in_function_name varchar(50),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_item_location`(
	IN in_item_location_id bigint,
	IN in_item_id bigint,
	IN in_location_id bigint
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_item_map`(
	IN in_item_map_id bigint,
	IN in_big_item_id bigint,
	IN in_small_item_id bigint,
	IN in_fraction_qty float,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_pay`(
	IN in_pay_id bigint,
	IN in_transaction_id bigint,
	IN in_pay_date date,
	IN in_paid_amount float,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_pay_method`(
	IN in_pay_method_id int,
	IN in_pay_method_name varchar(50)
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_points_card`(
	IN in_points_card_id bigint,
	IN in_card_number varchar(10),
	IN in_card_holder varchar(100),
	IN in_email varchar(100),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_points_card_balance`(
	IN in_card_number varchar(10),
	IN in_points float 
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_points_transaction`(
	IN in_points_transaction_id bigint,
	IN in_points_card_id bigint,
	IN in_transaction_date date,
	IN in_points_awarded float,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_store`(
	IN in_store_id int,
	IN in_store_name varchar(20)
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_sub_category`(
	IN in_sub_category_id int,
	IN in_category_id int,
	IN in_sub_category_name varchar(50)
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_transaction2`(
	IN in_transaction_id bigint,
	IN in_cash_discount float,
	IN in_total_vat float,
	IN in_edit_user_detail_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_transaction_item`(
	IN in_transaction_item_id bigint,
	IN in_transaction_id bigint,
	IN in_item_id bigint,
	IN in_batchno varchar(100),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_transaction_item2`(
	IN in_transaction_item_id bigint,
	IN in_item_qty float,
	IN in_unit_price float,
	IN in_unit_trade_discount float,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_transaction_reason`(
	IN in_transaction_reason_id int,
	IN in_transaction_type_id int,
	IN in_transaction_reason_name varchar(50)
)
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_transaction_type`(
	IN in_transaction_type_id int,
	IN in_transaction_type_name varchar(50),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_transactor`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_transactor_ledger`(
	IN in_transactor_ledger_id bigint,
	IN in_store_id int,
	IN in_store_name varchar(20),
	IN in_transaction_id bigint,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_user_category`(
	IN in_user_category_id int,
	IN in_user_category_name varchar(50)
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_user_detail`(
	IN in_user_detail_id int,
	IN in_user_name varchar(20),
	IN in_user_password varchar(255),
	IN in_first_name varchar(100),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_user_item_earn`(
	IN in_user_item_earn_id bigint,
	IN in_transaction_type_id int,
	IN in_transaction_reason_id int,
	IN in_user_category_id int,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_user_right`(
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_void_transaction`(
	IN in_transaction_id bigint,
	IN in_edit_user_detail_id int
)
BEGIN 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_void_transaction_item`(
	IN in_transaction_item_id bigint
)
BEGIN 
